...
const partners = [
  { name: 'UM6P ABS', tag: 'Université & Recherche' },
  { name: 'TAMWILCOM', tag: 'Fonds de Garantie Public' },
  { name: 'AMIC', tag: 'Association Investisseurs' },
  { name: '212 FOUNDERS', tag: 'Programme d’Accélération' },
  { name: 'CDG INVEST', tag: 'Capital Risque Institutionnel' },
  { name: 'TECHNOPARK', tag: 'Hub d’Incubation National' },
];
    ...
    <ScrollReveal variants={fadeUp} className="w-full py-8 space-y-8">
      ...
      <div className="w-full p-6 rounded-3xl bg-card text-foreground border border-border/40 shadow-soft-md space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] text-muted-foreground font-mono">{t('partnersTagline')}</span>
        </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1 pt-1">
                  ...
                  <div className="flex items-center gap-1.5">
                    <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-pulse-orange/10 text-pulse-orange">
                      {m.expertise}
                    </span>
                  </div>
                </div>
